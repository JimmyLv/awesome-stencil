describe('Controller: driverController', function () {
  ...
  beforeEach(inject(function ($controller, $rootScope, $httpBackend, $routeParams) {
    ...
    httpMock.expectJSONP("http://ergast.com/api/f1/2013/persons/vettel/driverStandings.json?callback=JSON_CALLBACK").respond(
    ...
    httpMock.expectJSONP("http://ergast.com/api/f1/2013/persons/vettel/results.json?callback=JSON_CALLBACK").respond(
